...
1) Instale o Jekyll (`gem install jekyll`) caso ainda nao tenha.
2) Rode `jekyll serve` e acesse `http://localhost:4000`.

Pronto para iterar no conteudo e estilos da landing.
